...
def wrapperPara(x, includeCen=False):
    ...
    for factor in allFactors:
        ...
        {'activation': 'ReLU', 'num_units': 100},
        {'activation': 'ReLU', 'num_units': 100},        
        {'activation': 'BentIdentity', 'num_units': 100},  ]
        
        nonlinear_coxph = NeuralMultiTaskModel(structure=structure, bins=100)
        ...
        nonlinear_coxph.fit(X, train_data['y'].flatten(), train_data['e']. flatten(), num_epochs = 500) 
        ...
        risks0 = nonlinear_coxph.predict_risk(x_new)
        ...
        for i in range(1, len(treatment_levels)): 
            ...
            risks1 = nonlinear_coxph.predict_risk(x_new)
